...
<x-layout>
    ...
    <div id="print">
        <div class="container mt-6 mb-6">
            ...
            <p>
                <?php echo ($en) ? 'Welcome to the teacher user guide for Assignment 5.' : 'Vitajte v učiteľskej používateľskej príručke pre Zadanie 5.'; ?>
                <br>
            ...
            <ul>
                ...
                <li>
                    <?php echo ($en) ? 'Credentials of your teacher account provided by your educational institution.' : 'Poverenia učiteľského účtu poskytnuté vašou vzdelávacou inštitúciou.'; ?></li>
            </ul>
            <br>
            ...
            <p>
                <?php echo ($en) ? 'After logging in, proceed to the "Teacher Page" where you can edit assignments for your students like set dates and the number of points they can achieve.' : 'Po prihlásení prejdite na „Stránka pre učiteľov“, kde môžete upravovať zadania pre svojich študentov, ako sú stanovenie termínov a počet bodov, ktoré môžu dosiahnuť.'; ?>
                <?php echo ($en) ? 'In the "See Table", Here you can look up if your students have done your assignments that you have given them. After that you can even download the data you need!' : 'V tabuľke „Pozri tabuľku“ si môžete vyhľadať, či vaši študenti splnili vaše úlohy, ktoré ste im zadali. Potom si môžete aj stiahnuť uložené údaje, ktoré potrebujete!'; ?>
                <?php echo ($en) ? 'After that, you can even look up your students tasks by clicking on their name and see what assignment they got and how they fare with it and download data you might need.' : 'Potom si môžete dokonca vyhľadať úlohy svojich študentov kliknutím na ich meno a zistiť, akú úlohu dostali a ako sa im darilo, a stiahnuť si údaje, ktoré by ste mohli potrebovať.'; ?>
            </p><br>
            ...
            <p>
                <?php echo ($en) ? 'Congratulations! You have successfully completed the teacher guide for Assignment 5.' : 'Gratulujeme! Úspešne ste dokončili učiteľskú príručku pre aplikáciu Zadanie 5.'; ?>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.5/jspdf.debug.js" charset="UTF-8"></script>
